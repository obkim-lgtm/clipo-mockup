...
- **홈 리뉴얼(할 일 중심 · 새 기능·연수·블로그 노출) 이어받기 → handoff/HANDOFF_home_renewal_260925.md** — 초안 `output/home_renewal_draft_260925.html`(#home만 보면 됨). 첫 과제 = 새 입구·임시 채점의 자리(온보딩 배너 자리는 반려).
